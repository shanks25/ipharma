        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
                <a href="{{ url('adminoperator/dashboard') }}" class="site_title" style="font-size: 18px;"><i class="fa fa-paw"></i> <span>Ipharma Limited</span></a>
            </div>
			...
			@include('adminoperatorslayouts.sidebar')

          </div>
        </div>

@include('adminoperatorslayouts.topbar')
