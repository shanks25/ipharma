            ...
            <div class="col-sm-6 col-xs-12" style="float: none; margin: 0 auto;">
                <div class="featured-box featured-box-primary featured-box-flat featured-box-text-left mt-md">
                    <div class="box-content">
                        <form role="form" method="POST" action="{{ url('adminoperator/login') }}">
                            <div class="col-sm-12">
                                <div class="form-content">
                                    {{ csrf_field() }}
                                    <h3 style="color: #0088cc !important" class="heading-text-color font-weight-normal">Admin Operator LOGIN</h3>
                                    <div class="clearfix"></div>
                                    @if (count($errors) > 0)
