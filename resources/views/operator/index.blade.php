    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
     <div class="box-body">
      ...
      <table id="example1" class="table table-bordered table-striped">
        ...
        <tbody>
          @foreach($adminoperators as $aggregator)
          <tr>
            <td>{{$loop->index + 1}}</td>
            ...
            <td><a href="{{ route('adminoperator.edit',$aggregator->id) }}"> <i class="fa fa-fw fa-edit"></i></a> </td> 
            
            <td>
              <form id="delete-form-{{$aggregator->id}}" method="post" action="{{ route('adminoperator.destroy',$aggregator->id) }}" style="display: none;">
