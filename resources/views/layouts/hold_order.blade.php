                ...
                <div class="row">
                    ...
                    <div style="display: block; margin: 10px 0; width: 100%; padding: 20px 0;">
                        ...
                        <p style="margin-bottom: 20px;">
                            We are happy to receive your IPharma Order #53415 kept on hold since we are unable to reach you via
                            phone for verification or unavailability of items. Please contact us for any query to our any 
                            helpline: 017 0 129 0 890 or 018 8 222 8 222 or write us to info@Ipharma24.com
                        </p>
                        <p style="margin-bottom: 20px;">
                            Below was the summary of your order.<br>
                            IPharma24.com 
                        </p>
                    </div>
