                ...
                <div class="row">
                    ...
                    <div style="display: block; margin: 10px 0; width: 100%; padding: 20px 0;">
                        ...
                        <p style="margin-bottom: 20px;">
                            Accept our sincere apology, your IPharma, Order #53415 has been cancelled due to not reaching you 
                            over phone/product unavailability/product price change etc. Please contact 
                            us for any further query to our any helpline: 017 0 129 0 890 or 018 8 222 8 222 or write us to 
                            info@Ipharma24.com.
                        </p>
                        <p style="margin-bottom: 20px;">
                            Take care, IPharma24.com
                        </p>
                    </div>
