...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Invoice #{{ $order->id }} | Ipharma24 Limited</title>
        <style type="text/css">
            body{
                background: #FFF;
                width: 70%;
                ...
                <div class="row">
                    ...
                    <div style="display: block; margin: 10px 0; width: 100%; padding: 20px 0;">
                        <p style="margin-bottom: 20px;">Hi 
                            ...
                            @endif,</p>
                        <p>Greetings from IPharma24!<p>
                        <p style="margin-bottom: 20px;">
                            We are happy to receive your order #30307 and save your 2 hours by avoiding traffic and long queue in
                            pharmacy stores. Now you can spend some quality time with your family or friends. Enjoy!
                        </p>
                        <p style="margin-bottom: 20px;">
                            You will receive a phone call for verification & price/delivery confirmation from us. Appreciate your co-operation. 
                            IPharma24.com
                        </p>
                        <p style="margin-bottom: 20px;">
                            Thank you for shopping with us. Below is the summary of your order.<br>
                            IPharma24.com 
                        </p>
                    </div>
