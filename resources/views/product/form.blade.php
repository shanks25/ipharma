...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            {{ Form::label('Regular Price', null, ['class' => 'col-sm-4', 'style' => 'line-height:35px;']) }}
                            <div class="col-sm-8">
                         ...
                         <div class="form-group">
                            {{ Form::label('Sale Price', null, ['class' => 'col-sm-4', 'style' => 'line-height:35px;']) }}
                            <div class="col-sm-8">
...
{{--                          <div class="form-group">
 <label for="status" class="col-sm-4">Product Type</label>
            ...
            $('#create-product').on('click', function(){
    			...
    			$.ajax({
    				...
    				success: function(res){
                        ...
                        var url = '{{ url('admin/product') }}/'+res.id;
