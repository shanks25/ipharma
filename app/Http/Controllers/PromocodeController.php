...
class Promocodecontroller extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect(route('promocodes.index'))->with('flash_success', trans('Discount Code created Successfully'));
        } catch (Exception $e) {
            return back()->with('flash_error', trans('form.whoops'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $Promocode->update($Update);
              return redirect(route('promocodes.index'))->with('flash_success', trans('Discount Code updated Successfully'));
        } catch (ModelNotFoundException $e) {
    ...
    public function destroy($id)
    {
       try {
            ...
            $Promocode->delete();
            return back()->with('flash_success', trans('Deleted Successfully'));
        } catch (ModelNotFoundException $e) {
            return back()->with('flash_error', trans('form.not_found'));
        } catch (Exception $e) {
            return back()->with('flash_error', trans('form.whoops'));
