...
<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="contact-details">
                    ...
                    <ul class="contact">
                        ...
                        <li><p><i class="fa fa-phone"></i> <strong>Phone:</strong><br> +880 1817-2990742</p></li>
                        <li><p><i class="fa fa-envelope-o"></i> <strong>Email:</strong><br> <a href="mailto:info@ipharma.com">info@ipharma.com</a></p></li>
                        <li><p><i class="fa fa-clock-o"></i> <strong>Working Days/Hours:</strong><br> Sat - Thu / 10:00 AM - 7:00 PM</p></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="col-md-3">
                ...
                <div class="tagcloud">
                    <ul>
                        ...
                        <li><i class="fa fa-meetup"></i>&nbsp;<a href="{{url('partners')}}">Partners</a></li>
            ...
            <div class="col-md-3">
                <h4>Mobile App</h4>
                <a href="#">
                    <img src="{{ Theme::asset('img/google_play1.png') }}" alt="Epharma"/>
                </a>
            </div>
            <div class="col-md-3">
                <div class="newsletter">
                    ...
                    <ul class="social-icons">
                        <li class="social-icons-facebook" style="color: #9e9e9e;"><a href="http://www.facebook.com/" target="_blank" title="Facebook"><i class="fa fa-facebook"></i></a></li>
    ...
    <div class="footer-copyright">
        <div class="container">
            <a href="index.html" class="logo" style="padding-top: 15px; margin-right: 20px;">
                <img style="width: 150px;" alt="Porto Website Template" class="img-responsive" src="{{ Theme::asset('img/logo-footer.png') }}">
            </a>
            ...
            <img style="width: 32%;" alt="Payments" src="{{ Theme::asset('img/payments.png') }}" class="footer-payment">
            <p class="copyright-text">© Copyright 2018. All Rights Reserved by Drogenide.</p>
            <p class="hidden"><a href="http://drogenidesoftwares.com" target="_blank"><?php echo 'THE MESSENGER' ?></a></p>
        </div>
    </div>
</footer>
</div>
